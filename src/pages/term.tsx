...
export const getServerSideProps = async () => {
  ...
  const seoData = {
    metadata: {
      ...
      description:
        "Điều khoản sử dụng website và dịch vụ của tổ chức Bàn Chân Xanh. Quy định về việc sử dụng website, tham gia hoạt động và đóng góp.",
    },
  };
  ...
  const termSections: LegalSection[] = [
    ...
    },
    {
      ...
      description:
        "Khi bạn truy cập, sử dụng website hoặc tham gia các hoạt động của chúng tôi, bạn xác nhận rằng:",
      items: [
      ...
      subsections: [
        {
          ...
          description:
            "Chúng tôi cấp cho bạn quyền sử dụng website cho mục đích cá nhân, phi thương mại. Bạn có thể:",
          items: [
      ...
      subsections: [
        {
          ...
          description:
            "Khi đăng ký tham gia các hoạt động của chúng tôi, bạn cần:",
          items: [
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          description:
            "Trong các trường hợp sau, chúng tôi có thể xem xét hoàn trả đóng góp:",
          items: [
    ...
    },
    {
      ...
      description:
        "Chúng tôi cam kết bảo vệ thông tin cá nhân của bạn theo Chính sách bảo mật. Tuy nhiên, bạn cần lưu ý:",
      items: [
      ...
      subsections: [
        {
          ...
          description:
            "Tất cả nội dung trên website, bao gồm nhưng không giới hạn: Văn bản, hình ảnh, video, âm thanh; Logo, thương hiệu, thiết kế; Phần mềm, mã nguồn, cơ sở dữ liệu. Đều thuộc quyền sở hữu của Bàn Chân Xanh hoặc được cấp phép sử dụng.",
        },
        {
          title: "8.2. Sử dụng nội dung",
          description:
            "Bạn có thể: Chia sẻ liên kết đến website; Trích dẫn nội dung với ghi rõ nguồn; Sử dụng cho mục đích giáo dục, phi thương mại. Bạn không được: Sao chép, phân phối nội dung mà không có sự đồng ý; Sử dụng cho mục đích thương mại; Thay đổi hoặc xóa thông tin bản quyền.",
        },
      ],
    },
    {
      ...
      description:
        "Chúng tôi cung cấp website và dịch vụ như hiện tại và không đảm bảo: Website hoạt động liên tục không gián đoạn; Không có lỗi hoặc virus; Nội dung luôn chính xác và cập nhật; Kết quả cụ thể từ việc sử dụng dịch vụ. Chúng tôi không chịu trách nhiệm về: Thiệt hại trực tiếp hoặc gián tiếp do sử dụng website; Mất dữ liệu, lợi nhuận hoặc cơ hội kinh doanh; Hành vi của người dùng khác; Nội dung của các website liên kết.",
    },
    {
      title: "10. Chấm dứt sử dụng",
      description:
        "Chúng tôi có quyền chấm dứt hoặc hạn chế quyền sử dụng website của bạn nếu: Vi phạm các điều khoản này; Sử dụng website cho mục đích bất hợp pháp; Gây tổn hại đến hoạt động của tổ chức; Không tuân thủ các quy định an toàn. Bạn có thể chấm dứt sử dụng bất kỳ lúc nào bằng cách ngừng truy cập website.",
    },
    {
      title: "11. Thay đổi điều khoản",
      description:
        "Chúng tôi có quyền cập nhật, thay đổi các điều khoản này bất kỳ lúc nào. Khi có thay đổi: Chúng tôi sẽ thông báo trên website; Ngày cập nhật sẽ được ghi rõ; Việc tiếp tục sử dụng được coi là chấp nhận điều khoản mới.",
    },
    {
      ...
      subsections: [
        {
          ...
          description:
            "Mọi tranh chấp sẽ được giải quyết thông qua thương lượng hòa bình trước tiên.",
        },
        {
          title: "12.2. Trọng tài",
          description:
            "Nếu không thể thương lượng, tranh chấp sẽ được giải quyết bằng trọng tài theo quy định của pháp luật Việt Nam.",
        },
        {
    ...
    },
    {
      title: "14. Hiệu lực",
      description:
        "Điều khoản này có hiệu lực từ ngày 01/12/2024 và thay thế cho tất cả các thỏa thuận trước đó liên quan đến việc sử dụng website và dịch vụ của Bàn Chân Xanh.",
    },
  ];
