...
import styles from "@components/common/Newsletter/Newsletter.module.scss";
...
export const getServerSideProps = async () => {
  ...
  const newsContent: NewsContent = {
    pageIntro: {
      ...
      description:
        "Theo dõi những tin tức mới nhất về các hoạt động, sự kiện và thông báo quan trọng của tổ chức Bàn Chân Xanh. Cập nhật thường xuyên để không bỏ lỡ những thông tin hữu ích.",
    },
    featuredNewsSection: {
      sectionIntro: {
        tag: "Tin nổi bật",
      ...
      featuredNews: {
        ...
        description:
          "Tổ chức Bàn Chân Xanh thông báo khởi động chương trình hiking mùa đông 2024 với nhiều hoạt động thú vị tại các địa điểm nổi tiếng của Nhật Bản. Đăng ký ngay để không bỏ lỡ cơ hội khám phá vẻ đẹp thiên nhiên mùa đông.",
      ...
      items: [
        {
          ...
          description:
            "Nhìn lại một năm đầy thành công với 44 hoạt động và hơn 880 lượt tham gia. Cảm ơn tất cả thành viên đã đồng hành cùng chúng tôi.",
        ...
        },
        {
          ...
          description:
            "Tham gia chương trình tình nguyện dọn dẹp rác thải tại các khu vực thiên nhiên và góp phần bảo vệ môi trường.",
        ...
        },
        {
          ...
          description:
            "Tìm hiểu về văn hóa truyền thống Nhật Bản, cách ứng xử và những điều cần biết khi sống tại Nhật.",
        ...
        },
        {
          ...
          description:
            "Chuyến hiking tại Núi Takao với 25 thành viên tham gia. Khám phá vẻ đẹp thiên nhiên và tận hưởng không khí trong lành.",
        ...
        },
        {
          ...
          description:
            "Trải nghiệm camping tuyệt vời bên hồ Kawaguchi với view Núi Fuji. Hoạt động team building và giao lưu giữa các thành viên.",
        ...
        },
        {
          ...
          description:
            "Lịch hoạt động tháng 1/2025 đã được cập nhật. Đăng ký sớm để đảm bảo có chỗ trong các hoạt động yêu thích.",
    ...
    newsletterSection: {
      ...
      description:
        "Đăng ký nhận tin tức và thông báo mới nhất từ tổ chức Bàn Chân Xanh. Chúng tôi sẽ gửi thông tin về các hoạt động sắp tới và tin tức quan trọng.",
    },
    categoriesSection: {
      sectionIntro: {
        tag: "Danh mục",
...
const NewPage: React.FC<NewProps> = (props) => {
  ...
  const featuredNewsSection =
    newsContent?.featuredNewsSection || props.newsContent.featuredNewsSection;
  const latestNewsSection =
    newsContent?.latestNewsSection || props.newsContent.latestNewsSection;
  const newsletterSection =
    newsContent?.newsletterSection || props.newsContent.newsletterSection;
  const categoriesSection =
    newsContent?.categoriesSection || props.newsContent.categoriesSection;
                ...
                {featuredNewsSection?.featuredNews && (
                  <div className="wpo-featured-news-item">
                    <div className="wpo-news-img">
                      <Image
                        src={
                          typeof featuredNewsSection.featuredNews.image ===
                          "string"
                            ? featuredNewsSection.featuredNews.image
                            : getStrapiImageUrl(
                                featuredNewsSection.featuredNews.image?.url ||
                                  "",
                              )
                        }
                      ...
                      <div className="wpo-news-date">
                        <span>
                          {featuredNewsSection.featuredNews.date.split("/")[0]}
                        </span>
                        <span>
                          Th
                          {featuredNewsSection.featuredNews.date.split("/")[1]}
                        </span>
                      </div>
                    </div>
                    <div className="wpo-news-content">
                      <div className="wpo-news-meta">
                        <span>
                          ...
                          {featuredNewsSection.featuredNews.author}
                        </span>
                        <span>
                          <i className="fi flaticon-calendar"></i>{" "}
                          {featuredNewsSection.featuredNews.date}
                        </span>
                      ...
                      <h3>
                        <a href={featuredNewsSection.featuredNews.link || "#"}>
                          {featuredNewsSection.featuredNews.title}
                        </a>
                      </h3>
                      <p>{featuredNewsSection.featuredNews.description}</p>
                      <a
                        href={featuredNewsSection.featuredNews.link || "#"}
                        className="read-more"
                      >
                        Đọc thêm <i className="fi flaticon-right-arrow"></i>
                      </a>
                    </div>
                  </div>
                )}
                            ...
                            <Image
                              src={
                                typeof news.image === "string"
                                  ? news.image
                                  : getStrapiImageUrl(news.image?.url || "")
                              }
                              alt={news.title}
                              width={90}
                              height={90}
                  ...
                  <div className="wpo-news-item">
                    ...
                    <div className="wpo-news-content">
                      <div className="wpo-news-meta">
                        {news.author && (
                          <span>
                            <i className="fi flaticon-user"></i> {news.author}
                          </span>
                        )}
                        <span>
                          <i className="fi flaticon-calendar"></i> {news.date}
                        </span>
                      </div>
                      <h4>
                        <a href={news.link || "#"}>{news.title}</a>
