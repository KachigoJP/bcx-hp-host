                            ...
                            <div className="col-lg-8 col-md-12">
                                <div className="wpo-featured-news-item">
                                    <div className="wpo-news-img">
                                        <Image src="/images/blog/1.jpg" alt="Tin tức nổi bật" width={800} height={450} />
                                    ...
                                    <div className="wpo-news-widget">
                                        ...
                                        <div className="wpo-news-list">
                                            <div className="wpo-news-item">
                                                <div className="wpo-news-img">
                                                    <Image src="/images/blog/2.jpg" alt="Tin tức" width={90} height={90} />
                                                </div>
                                                <div className="wpo-news-content">
                                            ...
                                            <div className="wpo-news-item">
                                                <div className="wpo-news-img">
                                                    <Image src="/images/blog/3.jpg" alt="Tin tức" width={90} height={90} />
                                                </div>
                                                <div className="wpo-news-content">
                                            ...
                                            <div className="wpo-news-item">
                                                <div className="wpo-news-img">
                                                    <Image src="/images/blog/4.jpg" alt="Tin tức" width={90} height={90} />
                                                </div>
                                                <div className="wpo-news-content">
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="wpo-news-item">
                                    <div className="wpo-news-img">
                                        <Image src="/images/blog/5.jpg" alt="Tin tức" width={500} height={280} />
                                        <div className="wpo-news-date">
                                            <span>20</span>
                                            <span>Th12</span>
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="wpo-news-item">
                                    <div className="wpo-news-img">
                                        <Image src="/images/blog/6.jpg" alt="Tin tức" width={500} height={280} />
                                        <div className="wpo-news-date">
                                            <span>18</span>
                                            <span>Th12</span>
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="wpo-news-item">
                                    <div className="wpo-news-img">
                                        <Image src="/images/blog/7.jpg" alt="Tin tức" width={500} height={280} />
                                        <div className="wpo-news-date">
                                            <span>16</span>
                                            <span>Th12</span>
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="wpo-news-item">
                                    <div className="wpo-news-img">
                                        <Image src="/images/blog/8.jpg" alt="Tin tức" width={500} height={280} />
                                        <div className="wpo-news-date">
                                            <span>14</span>
                                            <span>Th12</span>
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="wpo-news-item">
                                    <div className="wpo-news-img">
                                        <Image src="/images/blog/9.jpg" alt="Tin tức" width={500} height={280} />
                                        <div className="wpo-news-date">
                                            <span>12</span>
                                            <span>Th12</span>
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="wpo-news-item">
                                    <div className="wpo-news-img">
                                        <Image src="/images/blog/10.jpg" alt="Tin tức" width={500} height={280} />
                                        <div className="wpo-news-date">
                                            <span>10</span>
                                            <span>Th12</span>
                                        </div>
