...
import { AboutContent, HistorySection, MissionItem } from "@/utils/interfaces/about";
    ...
    const missions: MissionItem[] = [
        {
            ...
            title: "Sứ mệnh",
            description: "Kết nối cộng đồng người Việt tại Nhật Bản thông qua các hoạt động thiên nhiên, tạo ra môi trường giao lưu và học hỏi tích cực.",
        },
        {
            icon: "fi flaticon-user",
            title: "Tầm nhìn",
            description: "Trở thành cầu nối vững chắc giữa cộng đồng người Việt và thiên nhiên Nhật Bản, góp phần xây dựng một xã hội bền vững và hài hòa.",
        },
        {
            icon: "fi flaticon-checked",
            title: "Giá trị cốt lõi",
            description: "Tôn trọng thiên nhiên, đoàn kết cộng đồng, minh bạch trong hoạt động và cam kết phát triển bền vững cho tương lai.",
        },
    ];
        ...
        items: [
            {
                ...
                description: "Bàn Chân Xanh được thành lập bởi nhóm bạn trẻ người Việt tại Tokyo với mong muốn kết nối cộng đồng.",
            },
            {
                year: "2021",
                month: "1",
                ...
                description: "Bắt đầu tổ chức các hoạt động hiking và camping thường xuyên, thu hút hơn 100 thành viên tham gia.",
            },
            {
                year: "2022",
                month: "1",
                ...
                description: "Mở rộng sang các hoạt động workshop về bảo vệ môi trường và kỹ năng sống xanh.",
            },
            {
                year: "2023",
                month: "1",
                ...
                description: "Thiết lập quan hệ hợp tác với các tổ chức môi trường và cộng đồng tại Nhật Bản.",
            },
            {
                year: "2024",
                month: "1",
                ...
                description: "Đạt được 500+ thành viên và tổ chức hơn 50 sự kiện, trở thành cộng đồng người Việt lớn nhất tại Nhật Bản.",
            },
        ],
    };
