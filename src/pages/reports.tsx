...
export const getServerSideProps = async () => {
    const seoData = {
        metadata: {
            ...
            description: "Xem các báo cáo hoạt động chi tiết của tổ chức Bàn Chân Xanh, bao gồm thống kê, kết quả và tác động của các hoạt động",
        },
    };
...
const ReportsPage: React.FC<ReportsProps> = (props) => {
    return (
        <Layout data={props.layout.data}>
            ...
            <section className="wpo-reports-intro-section section-padding">
                <div className="container">
