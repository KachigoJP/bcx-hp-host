...
const HomePage: React.FC = () => {
  ...
  const calculateTimeLeft = (
    ...
    const parsedStartDate =
      startDate instanceof Timestamp ? startDate.toDate() : new Date(startDate);
  ...
  return (
    <span>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12 col-12">
              <div className="wpo-about-wrap">
                <div className="wpo-about-img">
                  <Image
                    src="/assets/images/marathon1.jpg"
                    width={581}
                    height={576}
                    alt=""
                    style={{
            ...
            <div className="col-lg-6 col-md-12 col-12">
              <div className="wpo-about-text">
                ...
                <p>
                  Giảy chạy Gây Quỹ Thiện Nguyện 2025. Đây là một sự kiện thể
                  thao kết hợp hoạt động thiện đầy ý nghĩa nhằm gây quỹ hỗ trợ
                  cho các trẻ em ngèo ở vùng cao Việt Nam. Mỗi bước chạy của các
                  bạn sẽ là một đóng góp không nhỏ tới tương lai cho các be và
                  cả cho cộng cồng.Không chỉ là chạy hãy cùng nhau lan toả yêu
                  thương.
                </p>
                <p>
                  Vô cùng cảm ơn đến các nhà tài trợ đã cùng chúng tôi thực hiện
                  giải chạy này
                </p>
                <ul>
                  ...
                  <li>
                    Nhà tài trợ Đồng: Công ty XE ĐẠP TRỢ LỰC, XE ĐẠP OSAKA
                  </li>
                </ul>
              </div>
            </div>
      ...
      {["30km", "15km", "15km nữ", "5km", "5km nữ"].map(
                  ...
                  <div className="col-lg-6">
                    <div className="wpo-section-title">
                      ...
                      {courseData && courseData.status === "started" ? (
                        <h2>
                          {String(courseData.timeLeft.hours).padStart(2, "0")}:
                          {String(courseData.timeLeft.minutes).padStart(2, "0")}
                          :
                          {String(courseData.timeLeft.seconds).padStart(2, "0")}
                        </h2>
                      ) : null}
                    </div>
                  </div>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-lg-6 text-center mb-5">
                      <button
                        ...
                        onClick={onClickHandler(courseId)}
                      >
                        Bắt đầu
                      </button>
                    </div>
                    ...
                    <tbody>
                      {userData.map((user: any, index: number) => {
                        ...
                        return (
                          <tr
                            key={index}
                            className={getStatusClass(user.status, ranking)}
                          >
                            <td>{ranking}</td>
                            <td>{user.name}</td>
                            <td>{user.bib}</td>
