...
export const getServerSideProps = async () => {
    const seoData = {
        metadata: {
            ...
            description: "Cập nhật tin tức mới nhất về các hoạt động, sự kiện và thông báo của tổ chức Bàn Chân Xanh",
        },
    };
...
const NewsPage: React.FC<NewsProps> = (props) => {
    ...
    return (
        <Layout data={props.layout.data}>
            ...
            {/* News Intro Section */}
            <section className="wpo-news-intro-section section-padding">
                <div className="container">
