import { outdoorService, globalService } from "@/lib/strapi/services";
...
export const getServerSideProps = async () => {
  ...
  const seoData = {
    metadata: {
      page_code: "camping",
      title: "Hoạt động cắm trại - Bàn Chân Xanh",
      description:
        "Tham gia các hoạt động cắm trại khám phá thiên nhiên cùng Bàn Chân Xanh. Trải nghiệm cuộc sống ngoài trời và góp phần bảo vệ môi trường.",
    },
  };
  ...
  const pageIntro = {
    ...
    title: "Cắm trại cùng Bàn Chân Xanh",
    description:
      "Tham gia các hoạt động camping để trải nghiệm cuộc sống ngoài trời, kết nối với thiên nhiên và học hỏi kỹ năng sinh tồn. Chúng tôi tổ chức các chuyến cắm trại an toàn, thú vị và có ý nghĩa bảo vệ môi trường.",
  };
  ...
  const campingTypesSection: CampingTypesSection & BaseStrapiSection = {
    ...
    sectionIntro: {
      tag: "Các loại hình cắm trại",
      title: "Trải nghiệm đa dạng",
      description:
        "Chúng tôi tổ chức nhiều loại hình camping khác nhau để phù hợp với mọi sở thích và khả năng.",
    },
    items: [
      {
        title: "Camping Gia Đình",
        description:
          "Hoạt động camping dành cho gia đình với trẻ em. An toàn, thú vị và giáo dục về thiên nhiên.",
        ...
        equipments: [{ text: "Lều gia đình" }, { text: "Đồ chơi an toàn" }],
      },
      {
        title: "Camping Phiêu Lưu",
        description:
          "Trải nghiệm camping thực thụ với các hoạt động mạo hiểm và kỹ năng sinh tồn.",
        ...
        equipments: [{ text: "Lều cá nhân" }, { text: "Dụng cụ sinh tồn" }],
      },
      {
        title: "Camping Sinh Thái",
        description:
          "Kết hợp camping với hoạt động bảo vệ môi trường và học hỏi về hệ sinh thái.",
        image: "/images/camping-eco.jpg",
        icon: "flaticon-ecology",
        duration: "1-2 ngày",
        ageGroup: "12+ tuổi",
        activities: [{ text: "Nghiên cứu môi trường" }, { text: "Trồng cây" }],
        equipments: [{ text: "Dụng cụ nghiên cứu" }, { text: "Hạt giống" }],
      },
    ],
  };
  ...
  const campingSitesSection: CampingSitesSection & BaseStrapiSection = {
    ...
    sectionIntro: {
      ...
      description:
        "Các địa điểm camping được lựa chọn kỹ lưỡng để đảm bảo an toàn và trải nghiệm tuyệt vời.",
    },
    items: [
      {
        title: "Vườn Quốc Gia Cát Tiên",
        description:
          "Trải nghiệm camping trong rừng nhiệt đới với hệ động thực vật phong phú. Cơ hội quan sát các loài động vật hoang dã vào ban đêm.",
      ...
      },
      {
        title: "Bà Nà Hills",
        description:
          "Camping trên núi với khí hậu mát mẻ quanh năm. Thưởng thức cảnh quan tuyệt đẹp và không khí trong lành.",
      ...
      },
      {
        title: "Đảo Phú Quốc",
        description:
          "Camping bên bờ biển với hoàng hôn tuyệt đẹp. Trải nghiệm cuộc sống đảo và các hoạt động biển.",
      ...
      },
      {
        title: "Đà Lạt",
        description:
          "Camping trong rừng thông với khí hậu mát mẻ. Thưởng thức cảnh quan đồi núi và hồ nước trong xanh.",
  ...
  const activitiesSkillsSection: SectionDetailImageSectionIconListTextItems &
    ...
    sectionIntro: {
      ...
      description:
        "Trong các chuyến camping, bạn sẽ học được nhiều kỹ năng hữu ích và tham gia các hoạt động thú vị.",
    },
    items: [
      {
  ...
  const equipmentSection: SectionDetailSectionIconItems & BaseStrapiSection = {
    ...
    sectionIntro: {
      ...
      description:
        "Chúng tôi cung cấp đầy đủ thiết bị cần thiết và đảm bảo an toàn cho mọi chuyến camping.",
    },
    items: [
      {
        title: "Lều & Trại",
        description:
          "Lều camping chất lượng cao, phù hợp với từng loại hình hoạt động và số lượng người tham gia.",
        icon: "flaticon-placeholder",
      },
      {
        title: "Đồ Dùng Cá Nhân",
        description:
          "Ba lô, túi ngủ, đệm, đèn pin và các vật dụng cá nhân cần thiết cho chuyến camping.",
        icon: "flaticon-target",
      },
      {
        title: "Dụng Cụ Nấu Ăn",
        description:
          "Bếp gas, nồi, chảo, dụng cụ ăn uống và các thiết bị nấu ăn ngoài trời chuyên dụng.",
        icon: "flaticon-water-tap",
      },
      {
        title: "An Toàn & Y Tế",
        description:
          "Bộ sơ cứu y tế, bảo hiểm du lạch, liên lạc khẩn cấp và các biện pháp an toàn.",
  ...
  const environmentalPrinciplesSection: SectionDetailSectionIconItems &
    ...
    sectionIntro: {
      ...
      description:
        'Chúng tôi cam kết thực hiện camping có trách nhiệm với môi trường. Mọi hoạt động đều tuân thủ nguyên tắc "Leave No Trace" - không để lại dấu vết.',
    },
    items: [
      {
  ...
  const joinSection = {
    sectionIntro: {
      ...
      description:
        "Trải nghiệm cuộc sống ngoài trời và góp phần bảo vệ môi trường cùng Bàn Chân Xanh.",
    },
    button: {
...
const CampingPage: React.FC<CampingProps> = (props) => {
  ...
  const [campingContent, setCampingContent] = useState<CampingContent | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    const fetchCampingContent = async () => {
      ...
      const campingContent =
        await outdoorService.getWithQueryString(queryString);
  ...
  const heroSection =
    campingContent?.heroSection || props.campingContent.heroSection;
  const sections = campingContent?.sections || props.campingContent.sections;
  const campingTypesSection = sections?.find(
    (section) => section.__component === "ui.camping-types-section",
  ) as CampingTypesSection;
  const campingSitesSection = sections?.find(
    (section) => section.__component === "ui.camping-sites-section",
  ) as CampingSitesSection;
  const activitiesSkillsSection = sections?.find(
    (section) =>
      section.__component ===
      "common.section-detail-image-section-icon-list-text-items",
  ) as SectionDetailImageSectionIconListTextItems;
  const sectionDetailSectionIconItems = sections?.filter(
    (section) =>
      section.__component === "common.section-detail-section-icon-items",
  ) as SectionDetailSectionIconItems[];
  ...
  const joinSection =
    campingContent?.joinSection || props.campingContent.joinSection;
                    ...
                    <div className="wpo-service-item">
                      ...
                      <div className="wpo-service-text">
                        ...
                        <ul>
                          ...
                          <li>
                            Hoạt động:{" "}
                            {campingType.activities &&
                              campingType.activities.length > 0 &&
                              campingType.activities
                                .map((a) => a.text)
                                .join(", ")}
                          </li>
                          <li>
                            Thiết bị:{" "}
                            {campingType.equipments &&
                              campingType.equipments.length > 0 &&
                              campingType.equipments
                                .map((e) => e.text)
                                .join(", ")}
                          </li>
                  ...
                  <div key={index} className="col-lg-6 col-md-6 col-12">
                    <div className="wpo-project-item">
                      ...
                      <div className="wpo-project-text">
                        ...
                        <a
                          href={site.button?.link || "#"}
                          className="camping-button"
                        >
                          {site.button?.text}
                        </a>
                      </div>
                  ...
                  src={
                    activitiesSkillsSection?.image
                      ? typeof activitiesSkillsSection?.image === "string"
                        ? activitiesSkillsSection?.image
                        : getStrapiImageUrl(
                            activitiesSkillsSection?.image?.url ||
          ...
          <div className="row">
            <div className="col-12">
              <div className="wpo-cta-text">
                ...
                <p>
                  {environmentalPrinciplesSection?.sectionIntro?.description}
                </p>
                <div className="environmental-principles">
                  {environmentalPrinciplesSection &&
                    environmentalPrinciplesSection?.items &&
                    environmentalPrinciplesSection?.items?.length > 0 &&
                    environmentalPrinciplesSection?.items?.map(
                      (principle, index) => (
